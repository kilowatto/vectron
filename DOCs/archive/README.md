# Archive index / Índice del archivo

## English

Frozen snapshots of past product/engineering states. **Do not edit to rewrite history** — add a new dated file instead. See [`../00-docs-management.md`](../00-docs-management.md).

**Current living plan:** [`../02-master-plan.md`](../02-master-plan.md)

| File | Date | Topic |
|------|------|--------|
| [2026-07-17-vectron-plan-original.html](./2026-07-17-vectron-plan-original.html) | 2026-07-17 | Original full plan (Claude artifact HTML) |
...
Instantáneas congeladas de estados previos. **No editar para reescribir la historia** — añadir un archivo fechado nuevo. Ver [`../00-docs-management.md`](../00-docs-management.md).

**Plan vivo actual:** [`../02-master-plan.md`](../02-master-plan.md)

| Archivo | Fecha | Tema |
|---------|-------|------|
| [2026-07-17-vectron-plan-original.html](./2026-07-17-vectron-plan-original.html) | 2026-07-17 | Plan completo original (HTML del artifact) |
